...
class CalcMesh:
    ...
    def __init__(self, nodes_coords, tetrs_points):
        ...
        self.velocity = np.random.random_sample(self.velocity.shape)
    ...
    def snapshot(self, snap_number):
        ...
        writer.SetFileName("paraview/dergayu_ptitsu-step-" + str(snap_number) + ".vtu")
        writer.Write()
...
try:
    ...
    gmsh.merge(os.path.join(path, '1.stl'))
except:
